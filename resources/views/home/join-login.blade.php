...
<head>
    ...
    <script src="{{ asset('js/jssdk.js') }}" type="text/javascript" charset="utf-8"></script>
<body>
    

<div style="background:url(/images/join_bg.jpg) no-repeat left top; background-size:cover;position: absolute;width: 100%;height: 100%;text-align:center;">
    ...
    <ul>
        <li style="    display: flex;justify-content: center;height: 2rem;line-height: 2rem;">
            ...
            <input type="number" style="text-align:center;" name="joinPhone" value="{{ session('user_phone') }}" />
        </li>
        <br>
        <li style="    display: flex;justify-content: center;height: 2rem;line-height: 2rem;">
            <p style="padding:0 1rem 0 0;">密 码:</p>
            <input type="password" style="text-align:center;" name="joinPassword" />
        </li>
    </ul>
    <ol style="margin: 2rem 0 1rem 0;">
        <span style="background: #188aff;color: #FFF;border-radius: 1rem;padding:.5rem 3rem;" onclick="subJoin()">立即登录</span>
    </ol>
    <p>使用 <b style="text-decoration: underline;" onclick="isJoinCode()">短信验证码登录</b></p></div>
</body>
    <script>
            ...
            function isJoinPhone() {
                ...
                phoneBoxSub = layer.open({
                    type: 1
                    ,content: '<div style="background:url(/images/join_bg.jpg) no-repeat left top; background-size:cover;position: absolute;width: 100%;height: 100%;text-align:center;"><span class="layer_close_btn" onclick="closeLogin()">X</span><img style="width: 12rem;padding: 3rem 0 1rem 0;" src="/images/join_logo.png" alt="lgo" /><ul><li style="    display: flex;justify-content: center;height: 2rem;line-height: 2rem;"><p style="padding: 0 1rem 0 0;">账 号:</p><input type="number" style="text-align:center;" name="joinPhone" value="{{ session('user_phone') }}" /></li><br><li style="    display: flex;justify-content: center;height: 2rem;line-height: 2rem;"><p style="padding:0 1rem 0 0;">密 码:</p><input type="password" style="text-align:center;" name="joinPassword" /></li></ul><ol style="margin: 2rem 0 1rem 0;"><span style="background: #188aff;color: #FFF;border-radius: 1rem;padding:.5rem 3rem;" onclick="subJoin()">立即登录</span></ol><p>使用 <b style="text-decoration: underline;" onclick="isJoinCode()">短信验证码登录</b></p></div>'
                    ,anim: 'up'
            ...
            function isJoinCode() {
                codeBoxSub = layer.open({
                    type: 1
                    ,content: '<div style="background:url(/images/join_bg.jpg) no-repeat left top; background-size:cover;position: absolute;width: 100%;height: 100%;text-align:center;"><span class="layer_close_btn" onclick="closeLogin()">X</span><img style="width: 12rem;padding: 3rem 0 1rem 0;" src="/images/join_logo.png" alt="lgo" /><ul><li style="    display: flex;justify-content: center;height: 2rem;line-height: 2rem;"><p style="padding: 0 1rem 0 0;">账 号:</p><input type="number" style="text-align:center;" name="joinCodePhone" value="{{ session('user_phone') }}" /></li></ul><ol style="margin: 2rem 0 1rem 0;"><span style="background: #188aff;color: #FFF;border-radius: 1rem;padding:.5rem 3rem;" onclick="joinGetCode()">获取验证码</span></ol><p>使用 <b style="text-decoration: underline;" onclick="isJoinPhone()">账号密码登录</b></p></div>'
                    ,anim: 'up'
                    ,style: 'position:fixed; left:0; top:0; width:100%; height:100%; border: none; -webkit-animation-duration: .5s; animation-duration: .5s;'
                });
