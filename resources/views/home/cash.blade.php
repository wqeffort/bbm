...
<div class="join_head">
    ...
    <h3>提 现 操 作</h3>
    <a href="{{ url('cash/log') }}" style="color:#EEE;">账户明细</a>
</div>
@if ($card->isNotEmpty())
    <div class="bank_add">
        ...
        <ul>
            <li>
                ...
                <select id="type" style="height: auto;font-size: 1.2rem;" onchange="getBalance()">
                    ...
                    <option value="1">债权收益-兑换</option>
                    <option value="2">产权收益-兑换</option>
                    <option value="7">推广收益-兑换</option>
                </select>
            </li>
            <li>
                <span>对应账户余额: </span>
            ...
            <li style="flex-wrap: wrap; margin: 0" class="goods_attr_info">
                ...
                <p style="text-align: right;color: #666;margin-top: .5rem;"><i class="fa fa-info-circle"></i> 兑换金额必须为10的整数倍</p>
            </li>
        </ul>
