...
<div class="user_nav" style="width: 10rem;">
    <a href="#leftMenuBtn" style="background: -webkit-linear-gradient(140deg,#e0d600 0%,#7db802 50%,#3da503 100%);
    background: -ms-linear-gradient(140deg,#e0d600 0%,#7db802 50%,#3da503 100%);
    background: -o-linear-gradient(140deg,#e0d600 0%,#7db802 50%,#3da503 100%);
    background: -moz-linear-gradient(140deg,#e0d600 0%,#7db802 50%,#3da503 100%);
    background: linear-gradient(140deg,#e0d600 0%,#7db802 50%,#3da503 100%);margin: .7rem;padding: .2rem .5rem;"><i class="fa fa-bars" aria-hidden="true"></i> 菜单</a>
</div>
<div class="join_head">
    <a style="width: 4rem;"></a>
    <h3>兑 换 操 作</h3>
    <a href="{{ url('join/spring/cash/log') }}" style="color:#EEE;">账户明细</a>
</div>
@if ($card->isNotEmpty())
    <div class="bank_add">
        <p style="color:#666;">进行提现操作,请务必 <a href="{{ url('bank/create/spring') }}">绑定银行卡</a></p>
        <ul>
            <li>
                <span>选择提现项目: </span>
                <select id="type" style="height: auto;font-size: 1.2rem;" onchange="getBalance()">
                    <option value="0">== 请选择 ==</option>
                    <option value="6">春蚕账户-提现</option>
                </select>
            </li>
            <li>
                <span>对应账户余额: </span>
            ...
            <li style="flex-wrap: wrap; margin: 0" class="goods_attr_info">
                ...
                <p style="text-align: right;color: #666;margin-top: .5rem;"><i class="fa fa-info-circle"></i> 提现金额必须大于等于5000,为100的整数倍</p>
            </li>
        </ul>
