...
<div class="desc">
    ...
    <div class="content">
        <b>伯爵会员</b>
        <p>会员优惠：获赠100,000的消费积分</p>
        <p>办理方式：在梦享家俱乐部网站或指定官方活动支付100,000RMB成为伯爵会员</p>
        <b>服务说明：</b>
...
<div class="goods_nav_bottom">
    <ul>
        ...
        <li style="width: 50%;background: #C40000;line-height: 1.2rem;padding: 0.3rem;" onclick="member()">
            <span><b id="totalPrice">100000</b> 元  </span>
...
<script type="text/javascript">
    function member() {
        // location.href = '{{ url('buyMember') }}/100000';
        layer.open({
            content: '请联系客服进行购买!'
            ,btn: '我知道了'
        });
