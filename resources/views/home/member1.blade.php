...
<div class="desc">
    ...
    <div class="content">
        <b>男爵会员</b>
        <p>会员优惠：会员获赠10000消费积分</p>
        <p>办理方式：在梦享家俱乐部网站或指定官方活动支付1,0000RMB成为男爵会员</p>
        <b>服务说明：</b>
...
<div class="goods_nav_bottom">
    <ul>
        ...
        <li style="width: 50%;background: #C40000;line-height: 1.2rem;padding: 0.3rem;" onclick="member()">
            <span><b id="totalPrice">10000</b> 元  </span>
...
<script type="text/javascript">
    function member() {
        ...
        $.post('{{ url('getUserRank') }}',{
            ...
            if (obj.data < 2) {
                location.href = '{{ url('buyMember') }}/10000';
            }else{
                layer.open({
