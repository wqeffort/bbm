            ...
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" required value="{{ $banner->title }}" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input class="layui-input" disabled="disabled" value="{{ $banner->img }}" name="img">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="oss" required value="{{ $banner->img }}" disabled="disabled" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="link" required value="{{ $banner->link }}"  class="layui-input">
                    </div>
                </div>

                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <a href="javascript:;" onclick="sub({{ $banner->id }})" class="layui-btn" lay-submit >立即提交</a>
...
function sub(id) {
    ...
    loading()
    if (title && img && link) {
        $.post('{{ url('service/app/banner/edit') }}/'+id,{
            "_token" : '{{ csrf_token() }}',
            "title" : title,
            "img" : img,
            "link" : link
