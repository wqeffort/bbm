...
@section('body')
		<div class="weadmin-body">
			<blockquote class="layui-elem-quote">今天 {{ date('Y年m月d日 H:i:s') }} --  欢迎登录S.J.A.G 后台管理系统</blockquote>
			...
			<div class="layui-col-lg12 layui-collapse" style="border: none;">
				<div class="layui-col-lg6 layui-col-md12">
					...
					<fieldset class="layui-elem-field" style="padding: 5px;">
						<!--WeAdmin公告-->
						<div class="layui-card">
							<div class="layui-card-header layui-elem-quote">S.J.A.G 公告</div>
							<div class="layui-card-body">
						...
						<ul class="layui-timeline" style="height: 729px; overflow-y: auto;">
							...
							<li class="layui-timeline-item">
								...
								<div class="layui-timeline-content layui-text">
									<div class="layui-timeline-title">
										<h3>正在开发中</h3>
										<span class="layui-badge-rim">2018-12-28</span>
									</div>
									<ul>
										<li>接入便签功能</li>
									</ul>
							...
							<li class="layui-timeline-item">
								...
								<div class="layui-timeline-content layui-text">
									<div class="layui-timeline-title">
										<h3>S.J.A.G 后台立项</h3>
										<span class="layui-badge-rim">2018-12-25</span>
									</div>
								</div>
							</li>
							<li class="layui-timeline-item">
							...
							<li class="layui-timeline-item">
								...
								<div class="layui-timeline-content layui-text">
									<div class="layui-timeline-title">
										<h3>增加人员管理</h3>
										<span class="layui-badge-rim">2019-01-25</span>
									</div>
								</div>
							</li>
							<li class="layui-timeline-item">
