...
@section('body')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="#">融通四海</a> &raquo; 项目管理 &raquo; 创建项目
    </div>
    <!--面包屑导航 结束-->
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>单期年化收益(三个月)</th>
                        <td>
                            <input type="number" name="odds_1">
                        </td>
                    </tr>
                    <tr>
                        <th>两期年化收益(六个月)</th>
                        <td>
                            <input type="number" name="odds_2">
                        </td>
                    </tr>
                    <tr>
                        <th>开始时间</th>
