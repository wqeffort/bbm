...
@section('body')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="#">品牌品牌</a> &raquo; 品牌列表
    </div>
    <!--面包屑导航 结束-->
        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    <a href="{{ url('admin/brand/add') }}"><i class="fa fa-plus"></i>添加品牌</a>
                ...
                <table class="list_tab">
                    ...
                    @if ($brand->isNotEmpty())
                        ...
                        <tr>
                            ...
                            <td class="tc">{{ $value->brand_name }}</td>
                            <td class="tc">
                                <img class="user_pic" src="{{ url($value->brand_pic) }}">
                            </td>
                            <td class="tc">{{ $value->brand_title }}</td>
                            <td class="tc">
                                @if ($value->status == 1)
                            ...
                            <td class="tc">
                                <a href="{{ url('admin/brand/show') }}/{{ $value->id }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
...
<script type="text/javascript">
    ...
    function status(id) {
        $.post('{{ url('admin/brand/status') }}/'+id, {
            "_token" : '{{ csrf_token() }}',
        }, function (ret) {
