        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    <a href="{{ url('admin/category/add') }}"><i class="fa fa-plus"></i>添加分类</a>
                ...
                <table class="list_tab">
                    ...
                    @if ($cate->isNotEmpty())
                        ...
                        <tr>
                            ...
                            <td class="tc">{{ $value->category_name }}</td>
                            <td class="tc">
                                <img class="user_pic" src="{{ url($value->category_pic) }}">
                            </td>
                            <td class="tc">{{ $value->category_title }}</td>
                            <td class="tc">{{ $value->category_pid }}</td>
                            <td class="tc">
                                @if ($value->status == 1)
                            ...
                            <td class="tc">
                                <a href="{{ url('admin/category/show') }}/{{ $value->id }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
...
<script type="text/javascript">
    ...
    function status(id) {
        $.post('{{ url('admin/category/status') }}/'+id, {
            "_token" : '{{ csrf_token() }}',
        }, function (ret) {
