...
@section('body')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="#">报表导出</a> &raquo; 公账财务报表导出
    </div>
    <!--面包屑导航 结束-->
...
function searchInfo() {
    ...
    if (time == '') {
        ...
        loading();
        $.post('{{ url('admin/table/finance/find') }}', {
            "_token" : '{{ csrf_token() }}',
            "time" : time
        }, function(ret) {
            console.log(ret);
            ...
            if (obj.status == 'success') {
                ...
                $.each(obj.data, function(index, val) {
                    ...
                    html += '<tr>\
                        ...
                        <td class="tc">'+val.uuid+'</td>\
                        <td class="tc">'+val.user_phone+'</td>\
                        <td class="tc">'+val.bank_card+'</td>\
                        <td class="tc">'+val.price+'</td>\
                        <td class="tc">'+type+'</td>\
                        <td class="tc">'+val.created_at+'</td>\
                        <td class="tc">'+val.admin+'</td>\
                        <td class="tc">'+val.img+'--'+val.log+'</td>\
                        <td class="tc">'+val.updated_at+'</td>\
                        </tr>'
                });
                var str = '<table class="list_tab">\
                    <tr>\
                        <th class="tc">ID序号</th>\
                        <th class="tc">提现用户</th>\
                        <th class="tc">用户编码</th>\
...
function printExcel() {
    ...
    console.log(time);
    location.href='{{url('admin/table/finance/print')}}/'+time;
}
</script>
@endsection