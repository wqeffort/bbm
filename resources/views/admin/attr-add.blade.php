            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>属性价格:</th>
                        <td>
                            <input type="number" class="sm" name="attrPrice">
                    ...
                    <tr>
                        <th>属性积分:</th>
                        <td>
                            <input type="number" class="sm" name="attrPoint">
                    ...
                    <tr>
                        <th>属性库存:</th>
                        <td>
                            <input type="number" class="sm" name="attrDepot">
                    ...
                    <tr id="goodsInfo" style="display: none;">
                        <th>商品信息</th>
                        <td>
                            <img id="goodsPic" style="width: 10rem;height: 10rem;" src="">
                            <h3>商品名称:<b id="goodsName"></b></h3>
                            <p>售卖价格(基础):<b id="goodsPrice"></b></p>
                            <p>售卖积分(基础):<b id="goodsPoint"></b></p>
                        </td>
                    </tr>
                    <tr>
                        <th>工作日志：</th>
