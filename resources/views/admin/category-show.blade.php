            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select id="category_pid">
                                <option value="{{ $data->category_pid }}">==保持不变==</option>
                                @if ($cate->isNotEmpty())
                    ...
                    <tr>
                        <th>分类描述:</th>
                        <td>
                            <input type="text" class="md" name="category_title" value="{{ $data->category_title }}">
                    ...
                    <tr>
                        ...
                        <td>
                            <script type="text/javascript">
                                ...
                                <input type="text" class="md" name="art_thumb" value="{{ $data->category_pic }}">
                    ...
                    <tr>
                        <th>缩略图</th>
                        <td>
                            <img src="{{ url($data->category_pic) }}" alt="" id="art_thumb_img" style="width: 175px;height: 175px">
                        </td>
                    </tr>
                    <tr>
                        <th>工作日志：</th>
...
function sub(id) {
    ...
    if (category_name == '') {
        ...
        loading();
        $.post('{{ url('admin/category/edit') }}/{{ $data->id }}',{
            "_token" : '{{ csrf_token() }}',
