...
@section('body')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="#">财务管理</a> &raquo; 提现列表
    </div>
    <!--面包屑导航 结束-->
        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    ...
                    <a href="{{ url('admin/finance/cashAll') }}"><i class="fa fa-plus"></i>历史提现</a>
                </div>
            </div>
            <!--快捷导航 结束-->
        </div>
                ...
                <table class="list_tab">
                    ...
                    @if ($data)
                        ...
                        <tr>
                            ...
                            <td class="tc"><img src="{{ $value->bank_logo }}" alt="">{{ $value->bank_name }}</td>
                            <td class="tc">{{ $value->bank_location }}</td>
                            <td class="tc">{{ $value->bank_card }}</td>
                            <td class="tc">{{ $value->name }}</td>
                            <td class="tc">
                                <a href="{{ url('admin/finance/cash') }}/{{ $value->id }}">
