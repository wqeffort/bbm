    ...
    <div class="result_wrap">
        ...
        <div class="tab_content">
            <table class="add_tab">
                <tr>
                    <th>商品名称：</th>
                    <td>
                        <input type="text" class="lg" name="goods_name" required="required">
                        <p>商品的名称不能为空！</p>
                    </td>
                </tr>
                <tr>
                    <th>商品描述：</th>
                    <td>
                        <input type="text" class="lg" name="goods_title" required="required">
                ...
                <tr>
                    <th>商品价格：</th>
                    <td>
                        <input type="number" name="goods_price"  required="required">
                        <p>商品的价格必须大于1</p>
                    </td>
                </tr>
                <tr>
                    <th>积分价格：</th>
                    <td>
                        <input type="number" name="goods_point"  required="required">
                        <p>商品的积分价格必须大于1</p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th>搜索关键词：</th>
                    <td>
                        <input type="text" class="lg" name="goods_search"  required="required">
        ...
        <div class="tab_content">
            <div class="goods_photo">
                <div id="divPreview" class="divPreview" style="width: 100%;display: flex;justify-content: space-between;">
                    <span style="float:left">（最多可上传五张图片）</span>
                </div>
                <input type="file" name="file" class="file" id="fileField"  />
                <input type="hidden" name="hash" id="hash" value="xoxo"/>
            </div>
            <p style="color: #C40000;">图片请保证足够的清晰度，正方形为优！</p>
        </div>
        <div class="tab_content">
            <script id="editor" name="goods_desc" type="text/plain" style="width:1000px;height:500px;"></script>
            <script type="text/javascript">
        ...
        <div class="tab_content">
            <script id="editor1" name="goods_service" type="text/plain" style="width:1000px;height:500px;"></script>
            <script type="text/javascript">
